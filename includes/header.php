...
<html lang="it">
    <head>
        ...
        <script src="<?php echo '/'.PROJECT_NAME.'/assets/js/popper-1.14.7.js?v='.filemtime(root('/'.PROJECT_NAME.'/assets/js/popper-1.14.7.js'));?>"></script>
        <script src="<?php echo '/'.PROJECT_NAME.'/assets/js/bootstrap-5.3.3.js?v='.filemtime(root('/'.PROJECT_NAME.'/assets/js/bootstrap-5.3.3.js'));?>"></script>
        <script src="<?php echo '/'.PROJECT_NAME.'/assets/js/functions.js?v='.filemtime(root('/'.PROJECT_NAME.'/assets/js/functions.js'));?>"></script>
        <title>MedPlus</title>
    </head>
