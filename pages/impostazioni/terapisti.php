<?php if(cookie('rowId',false))$edit=Terapisti()->first(['id'=>cookie('rowId',false)]); ?>
<div class="d-flex flex-row w-100 p-2">
    <button type="button" class="btn btn-primary p-2 d-flex flex-row modal-open">
        ...
        <div>Aggiungi Terapista</div>
    </button>
</div>
<div class="modal fade" id="terapistaModal" tabindex="-1" aria-labelledby="terapistaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="terapistaModalLabel"><?php echo cookie('rowId',false)?'Modifica Terapista':'Aggiungi Terapista';?></h1>
                <button type="button" class="btn-close btn-modal-cancel" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="impostazioni.php?tab=terapisti&rowId=unset&openModal=unset&action=<?php echo cookie('rowId',false)?'update':'insert';?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="modalTerapista" class="form-label">Terapista</label>
                        <input type="text" class="form-control" id="modalTerapista" name="terapista" value="<?php echo $edit['terapista']??'';?>">
                    </div>                         
...
<div class=" w-100 mx-1">
    <div class="card p">
        <?php $table=Terapisti()->select_for_table(['limit'=>6,'orderby'=>'id DESC']);?>
        <div class="card-body d-flex flex-column">
            ...
            <script>
                ...
                actions.listen();
                <?php if(cookie('openModal',false)) echo "openModal('terapistaModal');"?>
            </script>            
        </div>
