            ...
            <div class="modal-body save"
                ...
                <div class="d-flex flex-row">
                     <div class="p-2 flex-fill">
                        ...
                        <select class="form-control" name="id_categoria" value="<?php echo $uscita['id_categoria'] ?? ''; ?>" required <?php echo $disabled; ?>>
                    ...
                    <?php 
                        if(in_array( 'btn_add_uscite_categoria', $elementi )){?>
                            <div class="py-2 w-5 mt-auto" >
                                <button class="btn btn-primary w-100" onclick="window.modalHandlers['add_uscita'].addCategoria(this)" <?php echo $disabled; ?> >
                                    <?php echo icon('cloud-add.svg','white'); ?>
                                </button>
                            </div>
                            <div class="py-2 ms-1 w-5 mt-auto" >
                                <button class="btn btn-secondary w-100" onclick="window.modalHandlers['add_uscita'].editCategoria(this)" <?php echo $disabled; ?> >
                                    <?php echo icon('edit.svg','white'); ?>
                                </button>
                            </div>
                            <div class="py-2 ms-1 w-5 mt-auto" >
                                <button class="btn btn-dark w-100" onclick="window.modalHandlers['add_uscita'].delCategoria(this)"  <?php echo $disabled; ?>>
                    ...
                    <div class="p-2 w-30">
                        ...
                        <select class="form-control" name="id_uscita" value="<?php echo $uscita['id_uscita'] ?? ''; ?>" required  <?php echo $disabled; ?>>
                            <option>Seleziona</option>
                            <?php 
                    ...
                    <?php 
                        if(in_array( 'btn_add_uscite_in_capo_a', $elementi )){?>
                            <div class="py-2 w-5 mt-auto" >
                                <button class="btn btn-primary w-100" onclick="window.modalHandlers['add_uscita'].addUscita(this)"  <?php echo $disabled; ?>>
                                    <?php echo icon('cloud-add.svg','white'); ?>
                                </button>
                            </div>
                            <div class="py-2 ms-1 w-5 mt-auto" >
                                <button class="btn btn-secondary w-100" onclick="window.modalHandlers['add_uscita'].editUscita(this)"  <?php echo $disabled; ?>>
                                    <?php echo icon('edit.svg','white'); ?>
                                </button>
                            </div>
                            <div class="py-2 ms-1 w-5 mt-auto" >
                                <button class="btn btn-dark w-100" onclick="window.modalHandlers['add_uscita'].delUscita(this)"  <?php echo $disabled; ?>>
                                    <?php echo icon('bin.svg','white'); ?>
                                </button>
                            </div><?php
                        }
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="p-2 flex-fill">
                        ...
                        <input class="form-control" name="data_pagamento" type="date" value="<?php echo $uscita['data_pagamento'] ?? now('Y-m-d'); ?>" required  <?php echo $disabled; ?>/>
                    </div>
                    ...
                    <div class="p-2 w-50">
                        ...
                        <select 
                            class="form-control" 
                            name="tipo_pagamento" 
                            value="<?php echo $uscita['tipo_pagamento'] ?? ''; ?>" 
                            onchange="window.modalHandlers['add_uscita'].changeDataPagamento(this)"
                            required  
                            <?php echo $disabled; ?>
                            >
                            <option>Seleziona</option>
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="p-2 flex-fill">
                        ...
                        <select class="form-control" name="id_indirizzato_a" id="id_indirizzato_a" value="<?php echo $uscita['id_indirizzato_a'] ?? ''; ?>" required  <?php echo $disabled; ?>>
                            <option>Seleziona</option>
                            <?php 
                    ...
                    <div class="py-2 w-5 mt-auto" >
                        <button class="btn btn-primary w-100" onclick="window.modalHandlers['add_uscita'].addIndirizzato_a(this)" <?php echo $disabled; ?>>
                            <?php echo icon('cloud-add.svg','white'); ?>
                        </button>
                    </div>
                    <div class="py-2 ms-1 w-5 mt-auto" >
                        <button class="btn btn-secondary w-100" onclick="window.modalHandlers['add_uscita'].editIndirizzato_a(this)" <?php echo $disabled; ?>>
                            <?php echo icon('edit.svg','white'); ?>
                        </button>
                    </div>
                      <div class="py-2 ms-1 w-5 mt-auto">
                        <button class="btn btn-dark w-100"  onclick="window.modalHandlers['add_uscita'].delIndirizzato_a(this)" <?php echo $disabled; ?>>
                            <?php echo icon('bin.svg','white'); ?>
                        </button>
                    </div>
                </div>
                ...
                <div class="d-flex flex-row">
                     <div class="p-2 flex-fill">
                        ...
                        <textarea class="form-control" name="note" value="<?php echo $uscita['note']??''; ?>" required <?php echo $disabled; ?>><?php echo $uscita['note']??''; ?></textarea>
                    </div>
                </div>
