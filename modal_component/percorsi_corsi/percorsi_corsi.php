                        ...
                        <div class="container-fluid text-center">
                            <div class="table-responsive">
                                <div class="d-flex flex-row w-100 mb-2">
                                    ...
                                    <div class="d-none d-md-block w-15"><span>Inizio</span></div>
                                    <div class="d-none d-md-block w-15"><span>Prezzo Tabellare</span></div>
                            ...
                            foreach ($corsi as $corso) {?>
                                <div class="table-responsive">
                                    <div class="d-flex flex-row percorsi-row w-100 mb-2">
                                        ...
                                        <div class="d-none d-md-block w-15"><span><?php echo unformat_date($corso['data_inizio']); ?></span></div>
                                        <div class="d-none d-md-block w-15"><span><?php echo $corso['prezzo_tabellare']; ?></span></div>
