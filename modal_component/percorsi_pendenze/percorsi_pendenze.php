                ...
                <div class="p-2">
                    ...
                    <div class="container-fluid card text-center py-4">
                        <?php if(!$_trattamenti){?>
                            ...
                            <div class="accordion mb-1" id="trattamenti_1">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_trattamenti" aria-expanded="false" aria-controls="collapse_trattamenti">
                                            TRATTAMENTI
                                        </button>
                                    </h2>
                                    <div id="collapse_trattamenti" class="accordion-collapse collapse" data-bs-parent="#trattamenti_1">
                                        <div class="table-responsive title">
                                            <div class="my-0">
                                                <div class="flex-row titles w-100 d-flex fattura_row">
                                                    ...
                                                    <div class="cc4 d-flex align-items-center justify-content-center text-center">
                                                        <span class="d-none d-md-block">Trattamento</span>
                                        ...
                                        <?php foreach ($_trattamenti as $trattamento) {?>
                                            <div class="table-responsive">
                                                <div class="my-0">
                                                    <div class="flex-row titles w-100 d-flex fattura_row <?php echo (int)$trattamento['non_fatturato']==0?'disabled bg-light':''; ?>">
                                                        <div class="cc1 d-flex align-items-center justify-content-center text-center">
                                                        ...
                                                        <div class="cc4 d-flex align-items-center justify-content-center text-center"
                                                            ...
                                                            >
                                                            <span id="scadenza"><?php echo unformat_date($trattamento['scadenza']);?></span>
                                                        </div>
                                                        <div class="cc4 d-flex align-items-center justify-content-center text-center"
                                                                onmouseenter="window.modalHandlers['percorsi_pendenze'].enterRow(this)"
                                                                onmouseleave="window.modalHandlers['percorsi_pendenze'].leaveRow(this)"
                                                                onclick="window.modalHandlers['percorsi_pendenze'].clickRow(this)"             
                                                            >
                                                            <span id="trattamento"><?php echo $trattamento['nome'];?></span>
                                                        </div>
                                                        <div class="cc4 d-none d-md-flex align-items-center justify-content-center text-center"
                                                                onmouseenter="window.modalHandlers['percorsi_pendenze'].enterRow(this)"
                                                                onmouseleave="window.modalHandlers['percorsi_pendenze'].leaveRow(this)"
                                                        ...
                                                        <div class="cc4 d-flex align-items-center justify-content-center text-center"
                                                                ...
                                                                onclick="window.modalHandlers['percorsi_pendenze'].clickPrezzo(<?php echo $trattamento['id'].','.$trattamento['id_cliente']; ?>)"
                                                            >
                                            ...
                                            <div class="psm"></div><?php
                                        }?>
                                    </div>
                                </div>
                            </div>
                            <div class="psm"></div>
                            <?php foreach ($_corsi as $corsi) {?>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse_<?php echo $corsi['id'];?>" class="accordion-collapse collapse" data-bs-parent="#corso_<?php echo $corsi['id'];?>">
                                            <div class="table-responsive title">
                                                <div class="my-0">
                                                    <div class="flex-row titles w-100 d-flex fattura_row">
                                                        ...
                                                        <div class="cc4 d-flex align-items-center justify-content-center text-center">
                                                            <span class="d-none d-md-block">Corso</span>
                                                            <span class="d-md-none">Corso</span>
                                                        </div>
                                                        <div class="cc4 d-none d-md-flex align-items-center justify-content-center text-center">
                                                            <span class="">Tabellare</span>
                                                        </div>
                                            ...
                                            foreach(_corso($corsi['id_origine']) as $corso){?>
                                                <div class="table-responsive">
                                                    <div class="my-0">
                                                        <div class="flex-row titles w-100 d-flex fattura_row <?php echo (int)$corso['non_fatturato']==0?'disabled bg-light':''; ?>">
                                                            <div class="cc1 d-flex align-items-center justify-content-center text-center">
                                                                <input class="form-check-input" type="checkbox" id="id_percorso" origine="trattamenti" value="<?php echo $corso['id'];?>" disabled/>
                                                            </div>
                                                            <div class="cc4 d-flex align-items-center justify-content-center text-center"
                                                                    onmouseenter="window.modalHandlers['percorsi_pendenze'].enterRow(this)"
                                                                    onmouseleave="window.modalHandlers['percorsi_pendenze'].leaveRow(this)"
                                                                    onclick="window.modalHandlers['percorsi_pendenze'].clickRow(this)"             
                                                                >
                                                                <span id="scadenza"><?php echo unformat_date($corso['scadenza']);?></span>
                                                            </div>
                                                            <div class="cc4 d-flex align-items-center justify-content-center text-center"
                                                                    onmouseenter="window.modalHandlers['percorsi_pendenze'].enterRow(this)"
                                                                    onmouseleave="window.modalHandlers['percorsi_pendenze'].leaveRow(this)"
                                                                    onclick="window.modalHandlers['percorsi_pendenze'].clickRow(this)"             
                                                                >
                                                                <span id="trattamento"><?php echo $corso['nome'];?></span>
                                                            </div>
                                                            <div class="cc4 d-none d-md-flex align-items-center justify-content-center text-center"
                                                                    onmouseenter="window.modalHandlers['percorsi_pendenze'].enterRow(this)"
                                                                    onmouseleave="window.modalHandlers['percorsi_pendenze'].leaveRow(this)"
                                                            ...
                                                            <div class="cc4 d-flex align-items-center justify-content-center text-center"
                                                                    onmouseenter="window.modalHandlers['percorsi_pendenze'].enterPrezzo(this)"
                                                                    onmouseleave="window.modalHandlers['percorsi_pendenze'].leavePrezzo(this)"
                                                                    onclick="window.modalHandlers['percorsi_pendenze'].clickPrezzo(<?php echo $corso['id'].','.$corso['id_cliente']; ?>)"
                                                                >
